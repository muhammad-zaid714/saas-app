  ...
  <TableBody>
    {companions?.map(({id,subject,name,topic,duration}) => (
      <TableRow key={id}>
        ...
        <TableCell >
          <div className=" subject-badge w-fit max-md:hidden ">{subject.charAt(0).toUpperCase() + subject.slice(1)}</div>
         
          <div className="flex items-center gap-2 justify-center rounded-lg w-fit p-2 md:hidden" style={{backgroundColor:getSubjectColor(subject)}}>
